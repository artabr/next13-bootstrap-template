  ...
  return (
    <div className="container py-4 px-3 mx-auto">
      ...
      <header className="d-flex justify-content-between align-items-md-center pb-3 mb-5 border-bottom">
        <h1 className="h4">
          <a href="/" className="d-flex align-items-center text-dark text-decoration-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                 className="bi bi-bootstrap-fill d-inline-block me-2" viewBox="0 0 16 16">
              <path
        ...
        <a href="https://github.com/twbs/examples/tree/main/sass-js/" target="_blank" rel="noopener">View on
          GitHub</a>
      </header>

      <h1>Get started with Bootstrap</h1>
      <div className="col-lg-8 px-0">
        <p className="fs-4">You&#39;ve successfully loaded up a Bootstrap example! It&#39;s loaded up with <a
            href="https://getbootstrap.com/">Bootstrap 5</a> and tooling for compiling our Sass and JavaScript to your
          needs.</p>
        <p>If this button appears blue and the link appears purple, you&#39;ve done it!</p>
      </div>

      <button type="button" className="btn btn-primary me-3" data-bs-toggle="offcanvas"
              data-bs-target="#offcanvasExample">Toggle offcanvas
      </button>
      <a href="#" className="text-success">Example link</a>
      ...
      <hr className="col-1 my-5 mx-0" />
        ...
        <ul className="icon-list">
          <li><a href="https://getbootstrap.com/docs/5.2/getting-started/introduction/">Bootstrap quick start
            guide</a></li>
          ...
          <li><a href="https://getbootstrap.com/docs/5.2/getting-started/build-tools/">Contributing to Bootstrap</a>
          </li>
        </ul>
